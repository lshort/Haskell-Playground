...
/* package HDBC-postgresql-2.3.2.0 */
#define VERSION_HDBC_postgresql "2.3.2.0"
...
/* package snap-0.5.4 */
#define VERSION_snap "0.5.4"
#define MIN_VERSION_snap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 4)

/* package snap-core-0.5.4 */
#define VERSION_snap_core "0.5.4"
#define MIN_VERSION_snap_core(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 4)

/* package snap-server-0.5.4 */
#define VERSION_snap_server "0.5.4"
